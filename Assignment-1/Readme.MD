...
```bash
cd Assignment-1/Simple_ELF_Loader/without-bonus
make
```
...
![without-bonus terminal output](./part-a-without-bonus.png)
...
```bash
cd Assignment-1/Simple_ELF_Loader/with-bonus
make
```
...
![with-bonus terminal output](./part-a-with-bonus.png)
...
```text
Assignment-1/Simple_ELF_Loader/Complete_bootloader/
```
...
```bash
cd Assignment-1/Simple_ELF_Loader/Complete_bootloader
```
...
![QEMU bootloader output](./part-b-bootloader.png)
...
```text
CSE231-Programming-Assignments/
│
├── Assignment-1/
│   └── Simple_ELF_Loader/
│       │
...
│       ├── design-document.pdf
│       ├── PA-1.pdf
│       ├── part-a-without-bonus.png
│       ├── part-a-with-bonus.png
│       ├── part-b-bootloader.png
│       └── README.md
│
└── README.md
```
